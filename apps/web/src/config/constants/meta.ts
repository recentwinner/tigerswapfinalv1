...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Tigerswap exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for Tigerswap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Tigereswap exchanges.' },
    ...
    defaultTitleSuffix: t('TigerSwap'),
  }
}
